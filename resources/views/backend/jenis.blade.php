                                            ...
                                            <td class="text-center">
                                                ...
                                                <form action="/jenis-barang/{{ $item->id }}" method="post"
                                                    ...
                                                    <button class="btn btn-danger btn-icon  rounded-2"
                                                        onclick="return confirm('Yakin data {{ $item->jenis }} akan dihapus.? ') "
                    ...
                    <form action="/jenis-barang" method="post">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control @error('jenis_barang') is-invalid @enderror"
                                id="jenis_barang" name="jenis_barang" placeholder="a"
                                value="{{ old('jenis_barang') }}" onkeyup="myFunction()">
